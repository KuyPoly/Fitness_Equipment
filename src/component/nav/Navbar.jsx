  ...
  return (
    <nav className="navbar sticky-top navbar-expand-lg bg-warning">
      <div className="container-fluid">
        <Link className='navbar-brand fw-bold fs-3' to= "/">PowerFitness</Link>
        <div className="d-flex align-items-center">
          ...
          <div className="d-flex d-lg-none align-items-center me-2" ref={searchRef}>
            {!showSearch ? (
              ...
              <form className="d-flex w-100 ms-2" onSubmit={(e) => e.preventDefault()}>
                <input
          ...
          <div className="d-none d-lg-flex align-items-center ms-3" ref={searchRef}>
            {!showSearch ? (
              ...
              <form className="d-flex align-items-center" onSubmit={(e) => e.preventDefault()}>
                ...
                <Link to="/account" className="text-dark ms-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="27"
                    height="27"
